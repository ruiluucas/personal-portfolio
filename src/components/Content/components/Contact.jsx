import { Email, GitHub, Instagram, LinkedIn, Phone, Telegram, WhatsApp } from "@mui/icons-material";
...
export default function Contact() {
    return (
        ...
        >
            ...
            <motion.span style={{ textShadow: "0 0 5px #FFF, 0 0 100px #FFF" }} className="text-3xl font-bold">orçamento!</motion.span>
